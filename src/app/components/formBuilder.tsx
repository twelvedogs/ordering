                ...
                switch (obj[i].inputType) {
                    case "text":
                        result.push(<div key={i} className="form-group row"><label className={labelClass} htmlFor={i}>{camelCaseToWords(i)}</label>
                            <div className={controlClass}><input className="form-control" data-field={i} type="text" id={i} onChange={onchange} value={data[i]}></input></div></div>);
                        break;
                    case "number":
                        result.push(<div key={i} className="form-group row"><label className={labelClass} htmlFor={i}>{camelCaseToWords(i)}</label>
                            <div className={controlClass}><input className="form-control" data-field={i} type="number" id={i} onChange={onchange} value={data[i]}></input></div></div>);
                        break;
                    case "checkbox":
                        result.push(<div key={i} className="form-group row">
                            <div className={labelClass}>Choose</div>
                            <div className={`col-form-label ` + controlClass}><div className={`form-check`}><input className="form-check-input" data-field={i} type="checkbox" id={i} onChange={onchange}></input><label className="form-check-label" htmlFor={i}>{camelCaseToWords(i)}</label>
                            </div></div></div>);
                        break;
                    case "date":
                        result.push(<div key={i} className="form-group row"><label className={labelClass} htmlFor={i}>{camelCaseToWords(i)}</label>
                            <div className={controlClass}><input className="form-control" data-field={i} type="date" id={i} onChange={onchange}></input></div></div>);
                        break;
                    case "file":
                        result.push(<div key={i} className="form-group row"><label className={labelClass} htmlFor={i}>{camelCaseToWords(i)}</label>
                            <div className={controlClass}><input className="form-control" data-field={i} type="file" id={i} onChange={onchange}></input></div></div>);
                        break;
                    case "select":
                        ...
                        try{
                            result.push(<div key={i} className="form-group row"><label className={labelClass} htmlFor={i}>{camelCaseToWords(i)}</label>
                                <div className={controlClass}><select className="form-control" data-field={i} id={i} onChange={onchange}>
